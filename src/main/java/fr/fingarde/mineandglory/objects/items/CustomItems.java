...
public enum CustomItems
{
    ...
    VILLAGER_COIN(Material.CARROT_ON_A_STICK, 901, "Villager Coin", null),
    ...
    STONE_PICKAXE_HEAD(Material.IRON_NUGGET, 34001, "Stone Pickaxe Head", new JsonParser().parse("{\"ingredient\":\"ROCK\", \"amount\":\"3\"}").getAsJsonObject()),
    STONE_AXE_HEAD(Material.IRON_NUGGET, 34002, "Stone Axe Head", new JsonParser().parse("{\"ingredient\":\"ROCK\", \"amount\":\"3\"}").getAsJsonObject()),
    STONE_SHOVEL_HEAD(Material.IRON_NUGGET, 34003, "Stone Shovel Head", new JsonParser().parse("{\"ingredient\":\"ROCK\", \"amount\":\"3\"}").getAsJsonObject()),
    STONE_HOE_HEAD(Material.IRON_NUGGET, 34004, "Stone Hoe Head", new JsonParser().parse("{\"ingredient\":\"ROCK\", \"amount\":\"3\"}").getAsJsonObject()),
    STONE_SWORD_HEAD(Material.IRON_NUGGET, 34005, "Stone Sword Head", new JsonParser().parse("{\"ingredient\":\"ROCK\", \"amount\":\"3\"}").getAsJsonObject()),
    STONE_BLACKSMITH_HAMMER_HEAD(Material.IRON_NUGGET, 34006, "Stone Blacksmith Hammer Head", new JsonParser().parse("{\"ingredient\":\"ROCK\", \"amount\":\"3\"}").getAsJsonObject()),
    STONE_DAGGER_HEAD(Material.IRON_NUGGET, 34007, "Stone Dagger Head", new JsonParser().parse("{\"ingredient\":\"ROCK\", \"amount\":\"3\"}").getAsJsonObject()),
    STONE_HAMMER_HEAD(Material.IRON_NUGGET, 34008, "Stone Hammer Head", new JsonParser().parse("{\"ingredient\":\"ROCK\", \"amount\":\"3\"}").getAsJsonObject()),
    STONE_EXCAVATOR_HEAD(Material.IRON_NUGGET, 34009, "Stone Excavator Head", new JsonParser().parse("{\"ingredient\":\"ROCK\", \"amount\":\"3\"}").getAsJsonObject()),
    STONE_SHIELD_PLATE(Material.IRON_NUGGET, 34010, "Stone Shield Plate", new JsonParser().parse("{\"ingredient\":\"ROCK\", \"amount\":\"3\"}").getAsJsonObject()),
