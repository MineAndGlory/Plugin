...
public class Crops implements LootTableRegister
{
    @Override
    public void register()
    {
        LootTableManager.addLootTable("Potatoe", new LootTable().addEntry(
                new LootTable.Entry(CustomItems.getFromValue(CustomItems.VILLAGER_COIN))
        .setChance(1)
        .setMax(10)
        .setMin(1)
